# Generated by Django 5.0.2 on 2024-05-28 21:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(blank=True, null=True, upload_to='res/image/')),
                ('document', models.FileField(blank=True, null=True, upload_to='res/documents/')),
                ('video', models.FileField(blank=True, null=True, upload_to='res/videos/%y')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='room/image/')),
                ('document', models.FileField(blank=True, null=True, upload_to='room/documents/')),
                ('video', models.FileField(blank=True, null=True, upload_to='room/videos/')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
